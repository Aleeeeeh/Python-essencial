...
a)
print(geek) -> Sem as aspas é uma variável não definida
...
um índice inválido.(Ou seja posição que não existe).
...
a)
tupla = (11, 2, 31, 4)
print(tupla.sort()) -> Pois a função sort() é especifica da lista
