...
@seja_educado_mesmo (Forma indicada de fazer isso, dessa forma batemos o olho e vemos que é um decorator)
def dormir():
    print('Quero dormir...')
...
@checa_login Ou seja chama essa função primeiro que verifica se estão logado e em caso de não ele redireciona para 
tela de login
